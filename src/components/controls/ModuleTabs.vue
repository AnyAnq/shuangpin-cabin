<template>
  <div class="segmented-control" aria-label="练习模块">
    <button class="segment" :class="{ 'is-active': practice.module === 'poem' }" type="button" :disabled="practice.isSwitching" @click="practice.setModule('poem')">
      诗词句子
    </button>
